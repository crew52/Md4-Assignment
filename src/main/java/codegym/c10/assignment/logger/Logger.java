package codegym.c10.assignment.logger;
...
public class Logger {
    ...
    @Before("execution(public * codegym.c10.assignment.service.impl.ComputerService.*(..))")
    ...
    @AfterReturning(value = "execution(public * codegym.c10.assignment.service.impl.ComputerService.*(..))", returning = "result")
